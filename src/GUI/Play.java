...
public class Play extends BasicGameState {
    ...
    private final int limr = 60;
    private final int liml = 30;
    private final int limu = 25;
    private final int limd = 65;
    ...
    public void update(GameContainer gc, StateBasedGame sbg, int delta) throws SlickException {
        ...
        int xpos = Mouse.getX() - 70;
        int ypos = 768 - Mouse.getY() - 25;
        if (xpos <= shooter.xPos + limr && xpos >= shooter.xPos - liml && ypos <= shooter.yPos + limd && ypos >= shooter.yPos - limu) {
